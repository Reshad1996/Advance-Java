...
public abstract class Class26HMW01_Insurance {
    ...
    Class26HMW01_Insurance(String insuranceName){
...
class Car extends Class26HMW01_Insurance{
...
class Pet extends Class26HMW01_Insurance{
...
class Health extends Class26HMW01_Insurance{
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Class26HMW01_Insurance> insurances=new ArrayList<>();
        ...
        for (Class26HMW01_Insurance i:insurances
        ) {
            i.getQuote();
            i.cancelInsurance();
        }
